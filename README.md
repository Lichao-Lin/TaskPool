...
前往 [最新 Release](https://github.com/Lichao-Lin/TaskPool/releases/latest)，只需下载 **TaskPool-Setup-2.0.1-windows-x64.exe**，运行安装包即可。无需 Python，无需解压。
...
- 奖励以无边框小字号文字沿圆环外侧依次排列，文字从积分核心周围向外延伸，不对称铺满；每页最多 12 份，未用圆弧留空，支持翻页与完整详情。
...
- 界面与存储设置在页面内展开：三套预设主题、可点击的背景/文字/光效色板、自定义颜色（#RRGGBB），粘贴本地图片路径使用背景图片（PNG/JPG/WebP）。
